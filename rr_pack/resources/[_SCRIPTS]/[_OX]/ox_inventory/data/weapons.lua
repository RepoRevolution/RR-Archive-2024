return {
	Weapons = {
		...
		['WEAPON_HOMINGLAUNCHER'] = {
			label = 'Wyrzutnia naprowadzająca',
			weight = 10000,
			durability = 0.6,
		...
		['WEAPON_HEAVYPISTOL'] = {
			label = 'Enterprise Wide Body 1911',
			weight = 1100,
			durability = 0.2,
			ammoname = 'ammo-45'
		},
