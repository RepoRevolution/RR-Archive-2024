...
local function onStoreEnter(data)
    ...
    if jobName == (store.job or store.gang) then
        ...
        local prefix = Config.UseRadialMenu and "" or "~INPUT_CONTEXT~"
        if currentZone.name == "clothing" then
            Framework.ShowHelpNotification((_L("textUI.clothing")):format(prefix, Config.ClothingCost))
        ...
        elseif currentZone.name == "barber" then
            Framework.ShowHelpNotification((_L("textUI.barber")):format(prefix, Config.BarberCost))
        ...
        elseif currentZone.name == "tattoo" then
            Framework.ShowHelpNotification((_L("textUI.tattoo")):format(prefix, Config.TattooCost))
        ...
        elseif currentZone.name == "surgeon" then
            Framework.ShowHelpNotification((_L("textUI.surgeon")):format(prefix, Config.SurgeonCost))
...
local function onClothingRoomEnter(data)
    ...
    if jobName == (clothingRoom.job or clothingRoom.gang) then
        if CheckDuty() or clothingRoom.gang then
            ...
            local prefix = Config.UseRadialMenu and "" or "~INPUT_CONTEXT~"
            Framework.ShowHelpNotification((_L("textUI.clothingRoom")):format(prefix))
...
local function onPlayerOutfitRoomEnter(data)
    ...
    if isAllowed then
        ...
        local prefix = Config.UseRadialMenu and "" or "~INPUT_CONTEXT~"
        Framework.ShowHelpNotification((_L("textUI.playerOutfitRoom")):format(prefix))
