Locales["en"] = {
    ...
    textUI = {
        clothing = "Click %s, to use the services of ~y~clothing store",
        barber = "Click %s, to use the services of ~y~barber",
        tattoo = "Click %s, to use the services of ~y~tattoo shop",
        surgeon = "Click %s, to use the services of ~y~plastic surgeon",
        clothingRoom = "Click %s, to use ~y~clothing room",
        playerOutfitRoom = "Click %s, to browse ~y~your outfits"
    },
    migrate = {
        success = {
            title = "Success",
