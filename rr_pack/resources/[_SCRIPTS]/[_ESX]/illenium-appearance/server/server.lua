...
lib.addCommand("skin", {
    ...
    TriggerClientEvent("illenium-appearance:client:openClothingShop", target, true)
end)
...
lib.addCommand("propfix", { help = _L("commands.clearstuckprops.title") }, function(source)
